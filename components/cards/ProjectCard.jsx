...
import { filterDataItemInLang } from "/utils/tools/languages";
    ...
    <>
      ...
      >
        ...
        <section className="flex flex-col justify-between p-4 pb-2 duration-300 rounded-b-xl gap-y-4 bg-white/90 dark:bg-black/90">
          <h2 className="font-semibold text-md text-slate-700 dark:text-gray-300">
            {project[currentLanguage].title} - {project[currentLanguage].client}
          </h2>
          <div className="flex flex-row items-center justify-between">
            ...
            <p className="text-sm font-medium uppercase text-secondary/90">
              {project[currentLanguage].categories.join(", ")}
            </p>
          </div>
        </section>
      </article>
